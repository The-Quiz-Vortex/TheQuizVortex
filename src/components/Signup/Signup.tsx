            ...
            <Stack spacing={8} mx={'auto'} maxW={'lg'} py={12} px={6}>
                ...
                <Box rounded={'lg'} bg={useColorModeValue('white', 'gray.700')} boxShadow={'lg'} p={8}>
                    <Stack spacing={4}>
                        ...
                        <FormControl id="passwordConfirmation" isRequired isInvalid={!!errors.passwordConfirmation}>
                            <FormLabel>Confirm Password</FormLabel>
                            <InputGroup>
                                <Input type={showPassword ? 'text' : 'password'} placeholder="Confirm password" {...register('passwordConfirmation')} />
                                <InputRightElement h={'full'}>
                                    <Button
                                        variant={'ghost'}
                                        onClick={() => setShowPassword((showPassword) => !showPassword)}
