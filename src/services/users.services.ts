...
/**
 * Gets user details by phone number.
 * : Promise<object>
 * @param {string} phoneNumber - The phone number to search for.
 * @returns {Promise<Object>} A promise that resolves to the User object if found,
 * or undefined if no user exists with that phone number.
 */
export const getUserByPhone = (phoneNumber: string): Promise<DataSnapshot> => {
 ...
 */
export const createProfilePic = async (file: File, currentUser: string): Promise<string> => {
