        ...
        <Stack spacing={8} mx={'auto'} w={'3xl'} py={12} px={6}>
          ...
          <Box rounded={'lg'} bg={useColorModeValue('white', 'gray.700')} boxShadow={'lg'} p={8}>
            <Stack spacing={4}>
                  ...
                  <div key={field.id}>
                    <Box>
                      <FormControl
                        id="questionTitle"
                        isRequired
                        isInvalid={errors.question && !!errors.question[index]?.questionTitle}
                      >
                        <FormLabel>{`Question ${index + 1} title`}</FormLabel>
                        <Input
                          type="text"
                          placeholder="Question title"
                          {...register(`question.${index}.questionTitle`)}
                        />
                        <FormErrorMessage>
                          {errors.question && errors.question[index]?.questionTitle?.message}
                        </FormErrorMessage>
                      </FormControl>
                    </Box>
                    <FormControl
                      id="optionA"
                      isRequired
                      isInvalid={errors.question && !!errors.question[index]?.optionA}
                    >
                      <FormLabel>Option A</FormLabel>
                      <Input
                        type="text"
                        placeholder="Option A"
                        {...register(`question.${index}.optionA`)}
                      />
                      <FormErrorMessage>
                        {errors.question && errors.question[index]?.optionA?.message}
                      </FormErrorMessage>
                    </FormControl>
                    ...
                    <FormControl
                      id="optionB"
                      isRequired
                      isInvalid={errors.question && !!errors.question[index]?.optionB}
                    >
                      <FormLabel>Option B</FormLabel>
                      <Input
                        type="text"
                        placeholder="Option B"
                        {...register(`question.${index}.optionB`)}
                      />
                      <FormErrorMessage>
                        {errors.question && errors.question[index]?.optionB?.message}
                      </FormErrorMessage>
                    </FormControl>
                    ...
                    <FormControl
                      id="optionC"
                      isRequired
                      isInvalid={errors.question && !!errors.question[index]?.optionC}
                    >
                      <FormLabel>Option C</FormLabel>
                      <Input
                        type="text"
                        placeholder="Option C"
                        {...register(`question.${index}.optionC`)}
                      />
                      <FormErrorMessage>
                        {errors.question && errors.question[index]?.optionC?.message}
                      </FormErrorMessage>
                    </FormControl>
                    ...
                    <FormControl
                      id="optionD"
                      isRequired
                      isInvalid={errors.question && !!errors.question[index]?.optionD}
                    >
                      <FormLabel>Option D</FormLabel>
                      <Input
                        type="text"
                        placeholder="Option D"
                        {...register(`question.${index}.optionD`)}
                      />
                      <FormErrorMessage>
                        {errors.question && errors.question[index]?.optionD?.message}
                      </FormErrorMessage>
                    </FormControl>
              ...
              <Stack pt={6}>
                <Text align={'center'}>hsdbjhdjkhdjdhj</Text>
              </Stack>
            </Stack>
          </Box>
        </Stack>
